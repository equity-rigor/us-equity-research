...
| **B02** | Segment GM weighted average diverges from consolidated GM by >50bp (Datacenter GM corrupted 76.5% → 80.0%) | `scripts/verify_segment_gm.py` | G2 | C | All other 13 scripts must return 0 on B02 |
